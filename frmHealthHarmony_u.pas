...
var
  ...
  iXpos, iYpos, icountSCBItems : integer;
    ...
    begin
      ...
      if pos(uppercase(ssearch), uppercase(sline)) > 0
        ...
        begin
          ...
          grbRecipe.Caption := '';
          grbRecipe.Height := 300;
          grbRecipe.Width := 285;
          grbRecipe.Top := iypos;
          grbRecipe.Left := ixpos;

          ixpos := ixpos + grbRecipe.Width + 20;
          ...
          if lblRecipe.Width > grbRecipe.Width
            then
              begin
                sname1 := copy(srecipename, 1, pos(' ', srecipename))
                                + copy(srecipename, pos(' ', srecipename) + 1, pos(' ', srecipename));
                showmessage(sname1); //remove
                delete(srecipename, 1, length(sname1));
                sname2 := srecipename;
                lblRecipename.Caption := sname1 + #13 + sname2;
              end;
