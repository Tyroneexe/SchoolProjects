              ...
              if DataModule1.ADOTable1.FieldByName('ID').AsString = DataModule1.sUserID
                then
                  begin
                    ...
                    DataModule1.ADOTable1.FieldByName('OfAllTime').AsFloat := DataModule1.ADOTable1.FieldByName('OfAllTime').AsFloat + rTotalAmountInCheckout;

                    iIncItemsBought := DataModule1.ADOTable1.FieldByName('TotalBought').AsInteger;
                    inc(iIncItemsBought);
                    DataModule1.ADOTable1.FieldByName('TotalBought').AsInteger := iIncItemsBought;
      ...
      begin
        ...
        btnPreviewSell.Caption := 'Sell Product';
          ...
          begin
            ...
            DataModule1.ADOTable2.FieldByName('DatePickup').AsDateTime := dtpDatePickup.Date;

            //Die current user het hierdie produk verkoop
            DataModule1.ADOTable2.FieldByName('SellerID').AsString := DataModule1.sUserID;
            ...
            ShowMessage('user id:' + DataModule1.sUserID + #13 + 'seller id' + DataModule1.ADOTable2.FieldByName('SellerID').AsString);
                ...
                if DataModule1.ADOTable1.FieldByName('ID').AsString = DataModule1.sUserID
                  then
                    begin
                      ...
                      iIncTotalSold := DataModule1.ADOTable1.FieldByName('TotalSold').AsInteger;
                      inc(iIncTotalSold);
                      ...
                      DataModule1.ADOTable1.FieldByName('TotalSold').AsInteger := iIncTotalSold;
  ...
  begin
    ...
    if DataModule1.ADOTable1.FieldByName('ID').AsString = DataModule1.sUserID then
      begin
        ...
        redtAccInfo.Lines.Add('Total Items Sold:' + #9 + IntToStr(DataModule1.ADOTable1.FieldByName('TotalSold').AsInteger));
        redtAccInfo.Lines.Add('Total Items Bought:' + #9 + IntToStr(DataModule1.ADOTable1.FieldByName('TotalBought').AsInteger) + #13);
            ...
            if DataModule1.ADOTable2.FieldByName('ID').AsString = sBtnID
              then
                begin
                  ...
                  rAmountInCheckout := rAmountInCheckout + DataModule1.ADOTable2.FieldByName('Price').AsFloat;
