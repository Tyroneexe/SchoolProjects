...
type
  TfrmAbout = class(TForm)
    ...
    procedure pnlProductsNumberClick(Sender: TObject);
    procedure shpProductsMouseEnter(Sender: TObject);
    procedure shpProductsMouseLeave(Sender: TObject);
    procedure shpUsersMouseEnter(Sender: TObject);
    procedure shpUsersMouseLeave(Sender: TObject);
  private
    { Private declarations }
    iImgBackWidth, iImgBackHeight, iAantalUsers, iAantalProducts : integer;
...
procedure TfrmAbout.lblProductsClick(Sender: TObject);
begin
  //gaan na die Roder form
  frmRoder.Show;
  frmAbout.Hide;

  //Gaan na die products toe
  frmRoder.PageControl.TabIndex := 1;
end;

procedure TfrmAbout.pnlProductsNumberClick(Sender: TObject);
begin
  //gaan na die Roder form
  frmRoder.Show;
  frmAbout.Hide;
...
procedure TfrmAbout.shpProductsMouseEnter(Sender: TObject);
begin
  //Increase die size en wys die int
  shpProducts.Height := shpProducts.Height + 10;
  shpProducts.Top := shpProducts.Top - 5;

  shpProducts.Width := shpProducts.Width + 10;

  //Wys die int van die products
   shpProducts.Hint := IntToStr(iAantalProducts);

end;

procedure TfrmAbout.shpProductsMouseLeave(Sender: TObject);
begin
  //reset die size en verwyder die integer
...
procedure TfrmAbout.shpUsersMouseEnter(Sender: TObject);
begin
  //Increase die size en wys die int
  shpUsers.Height := shpUsers.Height + 10;
  shpUsers.Top := shpUsers.Top - 5;

  shpUsers.Width := shpUsers.Width + 10;

  //Wys die int van die users
  shpUsers.Hint := IntToStr(iAantalUsers);

end;

procedure TfrmAbout.shpUsersMouseLeave(Sender: TObject);
begin
  //reset die size en verwyder die integer
