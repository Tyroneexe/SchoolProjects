...
type
  TfrmSettings = class(TForm)
    ...
    procedure shpBlueContextPopup(Sender: TObject; MousePos: TPoint;
      var Handled: Boolean);
    procedure shpPurpleContextPopup(Sender: TObject; MousePos: TPoint;
      var Handled: Boolean);
    //
  private
...
procedure TfrmSettings.shpBlueContextPopup(Sender: TObject; MousePos: TPoint;
  var Handled: Boolean);
begin
...
procedure TfrmSettings.shpPurpleContextPopup(Sender: TObject; MousePos: TPoint;
  var Handled: Boolean);
begin
