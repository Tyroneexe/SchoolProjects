...
var
  ...
  slineid, sfoodname : string;
  ilineid, itelline : integer;
...
begin
  ...
  while not eof(tfile2) do
    begin
      readln(tfile2, sfoodname);
      inc(itelline);

      if ilineid = itelline
        then
          begin
            delete(sfoodname, pos('#', sfoodname), length(sfoodname));
